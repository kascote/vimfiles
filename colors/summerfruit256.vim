...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("NonText", "438ec3", "dde5eb", "")

    " Search
    call <SID>X("Search", "000000", "ffffaa", "")
    call <SID>X("IncSearch", "000000", "ffffaa", "")

    " Interface Elements
    call <SID>X("StatusLine", "43c464", "ffffff", "")
    call <SID>X("StatusLineNC", "9bd4a9", "51b069", "")
    call <SID>X("VertSplit", "3687a2", "3687a2", "")
    call <SID>X("Folded", "3c78a2", "c3daea", "")
    call <SID>X("IncSearch", "ffffaa", "000000", "")
    call <SID>X("Pmenu", "ffffff", "cb2f27", "")
    call <SID>X("SignColumn", "", "", "")
    call <SID>X("Cursor", "ffffff", "ff0000", "")
    call <SID>X("CursorLine", "", "dde5eb", "")
    call <SID>X("LineNr", "cccccc", "dde5eb", "")
    ...
    call <SID>X("Comment", "aaaaaa", "eeeeee", "")
